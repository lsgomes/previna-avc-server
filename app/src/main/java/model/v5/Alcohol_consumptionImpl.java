...
@OwlClassImplementation({
    Alcohol_consumption.class
})
public class Alcohol_consumptionImpl
    implements Alcohol_consumption
{
    ...
    public Alcohol_consumptionImpl() {
    }
     ...
     */
    @OwlIndividualId
    public Alcohol_consumptionImpl(String name) {
        this.name = name;
    }
