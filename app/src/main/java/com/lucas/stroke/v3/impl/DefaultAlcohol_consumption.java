 ...
 * Source Class: DefaultAlcohol_consumption <br>
 * @version generated on Sun Mar 05 19:13:36 BRT 2017 by dossluca
 */
public class DefaultAlcohol_consumption extends WrappedIndividualImpl implements Alcohol_consumption {

    public DefaultAlcohol_consumption(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
