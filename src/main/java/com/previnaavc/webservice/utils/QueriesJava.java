...
public class QueriesJava {
    ...
    public static String calculateAge(String individual) {
        return PREFIX +
                "SELECT ?result\n" +
    ...
    public static String calculatePropertiesWeights(String individual) {
        return PREFIX +
    ...
    public static String getRiskFactorsTips() {
        return PREFIX +
    ...
    public static String getRiskFactorsAchievements() {
        return PREFIX +
                "SELECT DISTINCT ?entity ?result\n" +
                "WHERE\n" +
                "{\n" +
